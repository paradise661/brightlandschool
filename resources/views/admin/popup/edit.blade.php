    ...
    <div class="content">
        <div class="card container-fluid mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit Popup - {{ $popup->name ?? '' }}</h5>
                        ...
                        <div class="card card-body main-description shadow br-8 p-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control br-8 @error('link') is-invalid @enderror" type="text"
                                    name="position" value="{{ old('link', $popup->link) }}" placeholder="Enter Link">
                                @error('link')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group mb-3 mt-2">
                                ...
                                <div class="custom-file">
                                    <input class="dropify @error('image') is-invalid @enderror" id="image"
                                        ...
                                        data-default-file="{{ $popup->image ? asset('storage/' . $popup->image) : '' }}"
