                        ...
                        <div class="card-body card shadow br-8">
                            ...
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-5" id="status" name="status">
                                    <option class="p-3" value="0" @if ($event->status == 0) selected @endif>
                                        Draft</option>
                                    <option class="p-3" value="1" @if ($event->status == 1) selected @endif>
                                        Publish</option>
                                </select>
                            </div>
                                ...
                                <select class="form-select ms-5" name="notice_categories_id" required>
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}"
                                            {{ old('notice_categories_id', $event->notice_categories_id) == $category->id ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
