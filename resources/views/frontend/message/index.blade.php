...
@section('content')
    ...
    <section class="py-16 md:py-20 lg:py-24 bg-white" id="principal-full-message">
        <div class="container mx-auto px-4 md:px-6">
            <div class="max-w-6xl mx-auto">
                <div class="grid lg:grid-cols-5 gap-8 lg:gap-12 mb-12">
                    <div class="lg:col-span-2">
                        <div class="sticky top-24">
                            <div class="bg-gradient-to-br from-primary to-blue-600 rounded-3xl overflow-hidden shadow-2xl">
                                <div class="h-80 md:h-96 overflow-hidden">
                                    <img class="w-full h-full object-cover"
                                        src="https://storage.googleapis.com/uxpilot-auth.appspot.com/f82523c8b1-84573293f55defe6c872.png"
                                        alt="professional male school principal in formal attire, confident and friendly, portrait without background" />
                                </div>
                                <div class="p-8 text-white">
                                    <h3 class="text-2xl md:text-3xl font-heading font-bold mb-2">Dr. James Anderson</h3>
                                    <p class="text-blue-100 font-semibold mb-4 text-lg">Principal</p>
                                    <div class="space-y-3 text-sm">
                                        ...
                                        <div class="flex items-center">
                                            <i class="fa-solid fa-award mr-3 text-lg"></i>
                                            <span>National Excellence Award 2022</span>
                                        </div>
                                        <div class="flex items-center">
                    ...
                    <div class="lg:col-span-3">
                        <div class="mb-8">
                            <span class="text-secondary font-semibold text-sm uppercase tracking-wider">From the Principal's
                                Desk</span>
                            <h2 class="text-3xl md:text-4xl font-heading font-bold text-gray-900 mt-4 mb-6">A Message of
                                Excellence and Growth</h2>
                        </div>
                        <div class="prose prose-lg max-w-none">
                            <div class="bg-blue-50 border-l-4 border-primary p-6 rounded-r-2xl mb-8">
                                <p class="text-xl md:text-2xl font-heading text-gray-800 italic leading-relaxed">"Education
                                    is not the filling of a pail, but the lighting of a fire. At Excellence Academy, we are
                                    committed to igniting that spark in every student."</p>
                            </div>

                            <div class="space-y-6 text-gray-700 text-base md:text-lg leading-relaxed">
                                <p>Dear Students, Parents, and Well-wishers,</p>

                                <p>It is with immense pride and joy that I welcome you to Excellence Academy, an institution
                                    that has been a beacon of quality education for over three decades. As the Principal of
                                    this esteemed institution, I am honored to lead a community of dedicated educators,
                                    enthusiastic students, and supportive parents who share our vision of educational
                                    excellence.</p>

                                <p>In today's rapidly evolving world, education extends far beyond textbooks and
                                    examinations. Our mission is to nurture well-rounded individuals who are not only
                                    academically proficient but also possess strong character, critical thinking abilities,
                                    and a deep sense of social responsibility. We believe that every child is unique, with
                                    their own set of talents and potential waiting to be discovered and developed.</p>

                                <div
                                    class="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 my-8 border border-gray-200">
                                    <h3 class="text-2xl font-heading font-bold text-gray-900 mb-6">Our Educational
                                        Philosophy</h3>
                                    <div class="grid md:grid-cols-2 gap-6">
                                        <div class="flex items-start">
                                            <div
                                                class="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                                                <i class="fa-solid fa-lightbulb text-primary text-xl"></i>
                                            </div>
                                            <div>
                                                <h4 class="font-bold text-lg mb-2">Innovative Learning</h4>
                                                <p class="text-gray-600 text-sm">Embracing modern teaching methodologies and
                                                    technology to enhance the learning experience.</p>
                                            </div>
                                        </div>
                                        <div class="flex items-start">
                                            <div
                                                class="w-12 h-12 bg-green-600/10 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                                                <i class="fa-solid fa-users text-green-600 text-xl"></i>
                                            </div>
                                            <div>
                                                <h4 class="font-bold text-lg mb-2">Personalized Attention</h4>
                                                <p class="text-gray-600 text-sm">Small class sizes ensuring individual focus
                                                    on each student's unique needs and abilities.</p>
                                            </div>
                                        </div>
                                        <div class="flex items-start">
                                            <div
                                                class="w-12 h-12 bg-purple-600/10 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                                                <i class="fa-solid fa-heart text-purple-600 text-xl"></i>
                                            </div>
                                            <div>
                                                <h4 class="font-bold text-lg mb-2">Character Building</h4>
                                                <p class="text-gray-600 text-sm">Fostering values of integrity, empathy, and
                                                    respect through daily interactions and programs.</p>
                                            </div>
                                        </div>
                                        <div class="flex items-start">
                                            <div
                                                class="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                                                <i class="fa-solid fa-globe text-accent text-xl"></i>
                                            </div>
                                            <div>
                                                <h4 class="font-bold text-lg mb-2">Global Perspective</h4>
                                                <p class="text-gray-600 text-sm">Preparing students to thrive in an
                                                    interconnected world with diverse cultures and ideas.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <p>At Excellence Academy, we have created an environment where curiosity is encouraged,
                                    questions are welcomed, and mistakes are viewed as learning opportunities. Our
                                    state-of-the-art infrastructure, combined with our experienced and passionate faculty,
                                    provides students with the tools and guidance they need to excel in their chosen fields.
                                </p>

                                <p>We understand that academic excellence is just one facet of a complete education. Through
                                    our comprehensive extracurricular programs, including sports, arts, music, drama, and
                                    community service, we ensure that students develop diverse skills and interests. These
                                    activities not only complement academic learning but also help students discover their
                                    passions and build confidence.</p>

                                <p>Our commitment to technology integration in education ensures that our students are
                                    well-prepared for the digital age. From smart classrooms to coding labs, from virtual
                                    reality experiences to online learning platforms, we leverage technology to make
                                    learning more engaging, interactive, and effective.</p>

                                <div class="bg-gradient-to-r from-primary/5 to-blue-50 rounded-2xl p-8 my-8">
                                    <h3 class="text-2xl font-heading font-bold text-gray-900 mb-4">Looking Ahead</h3>
                                    <p class="text-gray-700">As we move forward, we remain committed to continuous
                                        improvement and innovation. We are constantly evaluating and updating our
                                        curriculum, teaching methods, and facilities to ensure that we provide the best
                                        possible education. Our goal is not just to prepare students for examinations, but
                                        to equip them with the skills, knowledge, and values they need to become successful,
                                        responsible, and compassionate citizens of the world.</p>
                                </div>

                                <p>I am deeply grateful to our dedicated teaching staff, who go above and beyond to inspire
                                    and guide our students. Their commitment, expertise, and passion for teaching are the
                                    cornerstones of our success. I also extend my heartfelt thanks to our parents for their
                                    unwavering support and trust in our institution. Your partnership in your child's
                                    education is invaluable.</p>

                                <p>To our students, I encourage you to make the most of every opportunity that comes your
                                    way. Embrace challenges, pursue your passions, ask questions, think critically, and
                                    never stop learning. Remember that success is not just about grades; it's about becoming
                                    the best version of yourself and making a positive impact on the world around you.</p>

                                <p>Together, as a community of learners, educators, and supporters, we will continue to
                                    uphold the values and standards that make Excellence Academy truly exceptional. I look
                                    forward to working with all of you to create a bright and promising future for our
                                    students.</p>

                                <div class="mt-8 pt-8 border-t border-gray-300">
                                    <p class="font-semibold text-xl text-gray-900">With warm regards,</p>
                                    <p class="text-2xl font-heading font-bold text-primary mt-2">Dr. James Anderson</p>
                                    <p class="text-gray-600">Principal, Excellence Academy</p>
                                </div>
                            </div>
                        </div>
                    </div>
